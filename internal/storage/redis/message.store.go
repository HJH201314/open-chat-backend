...
func (r *RedisClient) CacheMessages(sessionID string, messages []models.Message) error {
	// 保留最近50条消息
...
func (r *RedisClient) GetCachedMessages(sessionID string) ([]models.Message, error) {
